...
На Streamlit Cloud загрузка `.mpp` идёт **чанками** через component bridge (не одним огромным base64) либо через живой Windows API-туннель с timeout; лимит файла — 40 МБ.
