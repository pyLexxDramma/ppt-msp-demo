...
export const FORMULAS: FormulaItem[] = [
  {
    id: 'plan_total',
    title: 'Итог плана за месяц',
    formula: 'Σ план[нед. 1…5]',
    detail: 'Сумма введённых плановых объёмов по всем пяти неделям отчётного месяца.',
  },
  {
    id: 'fact_total',
    title: 'Итог факта за месяц',
    formula: 'Σ факт[нед.], где факт задан',
    detail: 'Суммируются только недели с заполненным фактом (пустое поле не входит в сумму).',
  },
  {
    id: 'deviation',
  ...
  },
  {
    ...
    formula: 'ручной ввод',
    detail: 'Факт за прошлые периоды до текущего отчётного месяца.',
  },
  {
    id: 'done',
    title: 'Факт накопленный с начала',
    formula: 'накоплено_до_периода + Σ факт_месяца',
    detail: 'Накоплено до периода — ручной ввод (факт прошлых месяцев). Плюс факт текущего отчётного месяца.',
  },
  {
    id: 'remaining',
