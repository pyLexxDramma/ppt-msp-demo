...
export const FORMULAS: FormulaItem[] = [
  {
    ...
    title: 'План на месяц',
    formula: 'ввод',
    detail: 'Плановый объём на отчётный месяц (поле формы).',
  },
  {
    id: 'month_fact',
    title: 'Факт за месяц',
    formula: 'ввод',
    detail: 'Фактический объём за отчётный месяц (поле формы).',
  },
  {
    id: 'month_deviation',
    title: 'Отклонение за месяц',
    formula: 'план − факт',
    detail: 'Считается автоматически по полям «План на месяц» и «Факт за месяц».',
  },
  {
    id: 'plan_total',
    title: 'Итог плана (недели)',
    formula: 'Σ план[нед. 1…5]',
    detail: 'Сумма планов по неделям; для накопителя приоритет у поля «План на месяц», если задано.',
  },
  {
    id: 'fact_total',
    title: 'Итог факта (недели)',
    formula: 'Σ факт[нед.], где факт задан',
    detail: 'Сумма фактов по неделям; для накопителя приоритет у «Факт за месяц», если задано.',
  },
  {
    id: 'deviation',
